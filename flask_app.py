...
def addnew():
    ...
    ing1 = request.form["ing"], ingu1 = request.form["ingu"], ingn1 = request.form["ingn"],
    ing2 = request.form["ing1"], ingu2 = request.form["ingu1"], ingn2 = request.form["ingn1"],
    ing3 = request.form["ing2"], ingu3 = request.form["ingu2"], ingn3 = request.form["ingn2"],
    ing4 = request.form["ing3"], ingu4 = request.form["ingu3"], ingn4 = request.form["ingn3"],
    ing5 = request.form["ing4"], ingu5 = request.form["ingu4"], ingn5 = request.form["ingn4"],
    ing6 = request.form["ing5"], ingu6 = request.form["ingu5"], ingn6 = request.form["ingn5"],
    ing7 = request.form["ing6"], ingu7 = request.form["ingu6"], ingn7 = request.form["ingn6"],
    ing8 = request.form["ing7"], ingu8 = request.form["ingu7"], ingn8 = request.form["ingn7"],
    ing9 = request.form["ing8"], ingu9 = request.form["ingu8"], ingn9 = request.form["ingn8"],
    ing10 = request.form["ing9"], ingu10 = request.form["ingu9"], ingn10 = request.form["ingn9"],
    ing11 = request.form["ing0"], ingu11 = request.form["ingu0"], ingn11 = request.form["ingn0"],
    avocado = request.form.get("avocado"), pepper = request.form.get("pepper"), carrots = request.form.get("carrots"), celery = request.form.get("celery"),
    cabbage = request.form.get("cabbage"), cucumber = request.form.get("cucumber"), grapetom = request.form.get("grapetom"), kale = request.form.get("kale"),
    lemon = request.form.get("lemon"), lettuce = request.form.get("lettuce"), lime = request.form.get("lime"), mushroom = request.form.get("mushroom"),
    peas = request.form.get("peas"), poblano = request.form.get("poblano"), potatoes = request.form.get("potatoes"), redcab = request.form.get("redcab"),
    scallion = request.form.get("scallion"), snowpea = request.form.get("snowpea"), spinach = request.form.get("spinach"), sweetpotato = request.form.get("sweepotato"),
    tomato = request.form.get("tomato"), zucchini = request.form.get("zucchini"))
